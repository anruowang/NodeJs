...
var
	...
	jQuery = function( selector, context ) {
		...
		return new jQuery.fn.init( selector, context, rootjQuery );//避免死循环，参考第316行代码
	},
...
jQuery.fn = jQuery.prototype = {
	...
	constructor: jQuery,//所有的继承都要改一下constructor
	init: function( selector, context, rootjQuery ) {
		var match, elem;

		// HANDLE: $(""), $(null), $(undefined), $(false)
		if ( !selector ) {
			return this;//一个对象里面的this,谁调的init，this就是指向谁
		}
...
jQuery.fn.init.prototype = jQuery.fn;//其实init就是jquery对象。让init原型继承jquery方法
